...
#System commands
httpd_autostart='systemctl enable httpd'
...
harden_apache() {
	...
	sed -i "s|SSLProtocol all -SSLv3|SSLProtocol -ALL +TLSv1.2|g" /etc/httpd/conf.d/ssl.conf
	echo "\
ServerSignature Off
ServerTokens Prod
...
log INFO "Running: $httpd_autostart"
$httpd_autostart
